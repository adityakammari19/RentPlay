...
public class BookingController {
	...
	public List<Booking> getBookingsByUsernameandPlaygroundId(@PathVariable String username,@PathVariable Long playgroundId){
	...
	public List<Booking> getBookingsByOwnerUsernameandPlaygroundId(@PathVariable String username,@PathVariable Long playgroundId){
